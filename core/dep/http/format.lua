local urlencode_to_string = require("dep.urlencode").urlencode_to_string
local status_names = require("dep.http.status").status_names
local nan = 0 / 0
...
mod.http_response_to_string = function(res)
	...
	--[[TODO: http/2]]
	parts[#parts + 1] = "HTTP/1.1 " ..
			(res.status or 200) .. " " .. (res.status_text or status_names[res.status] or status_names[200]) .. "\r\n"
